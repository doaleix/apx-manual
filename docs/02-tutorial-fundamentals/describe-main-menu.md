...
It is also possible to customize the visibility of each menu option for a specific user. For more information regarding this, please check the [Roles section](/docs/13-tutorial-user-management/07-tutorial-roles/role-definition#roles)